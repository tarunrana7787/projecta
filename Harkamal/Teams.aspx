...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset class="field">
        ...
        The England cricket team is the team that represents England and Wales (and until 1992 also Scotland) in international cricket. Since 1 January 1997 it has been governed by the England and Wales Cricket Board (ECB),
         having been previously governed by Marylebone Cricket Club (MCC) from 1903 until the end of 1996.[6][7]
        England and Australia were the first teams to play a Test match (between 15–19 March 1877), and these two countries together with South Africa formed the Imperial Cricket Conference (predecessor to today's International Cricket Council)
         on 15 June 1909. England and Australia also played the first One Day International (ODI) on 5 January 1971. England's first Twenty20 International (T20I) was played on 13 June 2005, once more against Australia.
    </fieldset>
    <fieldset class="field">
        ...
        [4] The team also plays One Day International cricket and Twenty20 International, participating in both the first ODI, against England in the 1970–71 season[5] and the first Twenty20 International, 
        against New Zealand in the 2004–05 season,[6] winning both games. The team draws its players from teams playing in the Australian domestic competitions – the Sheffield Shield, 
        the Australian domestic limited-overs cricket tournament and the Big Bash League.
    </fieldset>
    <fieldset class="field">
        <legend class="legend">West Indies</legend>
        The West Indies cricket team, also known colloquially as the Windies, is a multi-national cricket team representing the West Indies Cricket Board, a 
        confederation of 15 mainly English-speaking Caribbean countries, British dependencies and non-British dependencies
